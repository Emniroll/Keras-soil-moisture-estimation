...
def data_load(seed):
    pic = pic_load(r"D:\Python PROJECT\new\d_10\data_10")
    lab = np.loadtxt(r'D:\Python PROJECT\new\d_10\val.txt', delimiter=",")
...
# input1, input2, label1, label2 = data_load(111111111)
# model.compile(loss=huber_loss, optimizer="adam")
# # checkpoint = ModelCheckpoint(r"C:\Users\Administrator\Desktop\best_weights.h5", monitor='val_loss',
# #                              save_weights_only=True, verbose=1, save_best_only=True, period=1)
# # if os.path.exists(r"C:\Users\Administrator\Desktop\best_weights.h5"):
# #     model.load_weights(r"C:\Users\Administrator\Desktop\best_weights.h5")
# #     # 若成功加载前面保存的参数，输出下列信息
